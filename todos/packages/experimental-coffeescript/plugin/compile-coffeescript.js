...
export class CoffeeCompiler extends CachingCompiler {
  ...
  compileOneFile(inputFile) {
    ...
    if (/(`|import|export)/.test(source)) {
      // If source contains backticks or 'import' or 'export',
      // pass the coffee output through babel-compiler.
      // This could result in false positives if 'import' or 'export' are
      // used not as keywords, but there’s no harm in passing through babelCompiler.
